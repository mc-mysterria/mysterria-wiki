...
description: "Detailed information about Sealed Artifacts on the server"
banner:
  content: |
...
There are two main ways to obtain a Sealed Artifact:
...
- Combat situations where a one-time powerful effect can turn the tide
